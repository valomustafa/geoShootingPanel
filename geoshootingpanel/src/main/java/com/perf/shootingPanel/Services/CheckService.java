...
public class CheckService implements Runnable {
    private static final Logger checkLogger = Logger.getLogger(CheckService.class);
    ...
    private final byte[] headVoltageCommand = {0x09, (byte)0xFF, (byte)0xFD, 0x00, (byte)0xB2, (byte)0xD9, 0x00, 0x00, 0x00, 0x00};
