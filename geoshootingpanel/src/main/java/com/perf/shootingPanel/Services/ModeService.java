...
public class ModeService implements Runnable {
    private static final Logger modeLogger = Logger.getLogger(ModeService.class);
    private final GpioPinDigitalOutput hybridPin = ShootingPanel.getModeSelectPin();
    private final GpioPinDigitalOutput resetPin = ShootingPanel.getResetPin();
