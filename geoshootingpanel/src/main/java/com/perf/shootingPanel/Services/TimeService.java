...
public class TimeService implements Runnable {
    private static final Logger timeLogger = Logger.getLogger(TimeService.class);
    private final AppController controller;
    private final SimpleDateFormat formatter = new SimpleDateFormat(Constants.DATE_FORMAT_SHORT);
    private final DS3231 rtc = ShootingPanel.getRtc();
