...
public class ReleaseService implements Runnable {
    private static final Logger releaseLogger = Logger.getLogger(ReleaseService.class);
    ...
    private String mode;
    private final byte[] releaseCommand = {0x09, (byte)0xFF, (byte)0xFD, 0x00, (byte)0x49, (byte)0x73, 0x00, 0x00, 0x00, 0x00};
