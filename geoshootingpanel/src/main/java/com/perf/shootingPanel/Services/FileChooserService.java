...
public class FileChooserService implements Runnable {
    private static final Logger chooserLogger = Logger.getLogger(FileChooserService.class);
    private final AppController controller;
    private final List<File> jobFiles = new ArrayList<>();
    private String menu;
    ...
    private final Image fileIcon = new Image(getClass().getResourceAsStream(Constants.FILE_IMAGE));
    private final Image folderIcon = new Image(getClass().getResourceAsStream(Constants.FOLDER_IMAGE));
