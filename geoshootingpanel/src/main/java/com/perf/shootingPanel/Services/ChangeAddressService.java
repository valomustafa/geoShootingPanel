...
public class ChangeAddressService implements Runnable {
    private static final Logger changeAddressLogger = Logger.getLogger(ChangeAddressService.class);
    private final AppController controller;
    private final Serial serial = ShootingPanel.getSerial();
    private final ObservableList<Switch> switches = FXCollections.observableArrayList();
    private int switchCount;
    private byte[] byteBuffer;
    private final byte[] address = new byte[3];
    ...
    private final StringBuilder switchAddress = new StringBuilder();
    private String addressToChange, addressToChangeTo;
    private int timeout = 0, newFoundSwitch = 0, switchIndex = 0;
    private boolean isPassed = true;
    private final String previousSwitch = Constants.BLANK_SPACE;
